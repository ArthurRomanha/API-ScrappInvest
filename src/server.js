...
module.exports = async (req, res) => {
    ...
    if (req.method === 'OPTIONS') {
        ...
        try {
            let fundosAtualizados = await main(indicesPadrão, fundos); // Chama a função main passando os fundos
        ...
        fundosPadrao = await main(fundosPadrao);
        res.status(200).json({ fundosPadrao });
    } else {
